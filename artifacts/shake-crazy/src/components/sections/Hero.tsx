      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground font-medium mb-10 max-w-xl mx-auto lg:mx-0 hero-text">
          ...
          <div className="relative hero-truck perspective-1000 hidden sm:block">
            ...
            <img 
              ...
              className="w-full h-auto drop-shadow-2xl transform rotate-y-[-10deg] rotate-x-[5deg]"
            />
          </div>
        </div>
      </div>
